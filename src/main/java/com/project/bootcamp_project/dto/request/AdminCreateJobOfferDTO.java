...
public class AdminCreateJobOfferDTO {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("AdminCreateJobOfferDTO{");
    ...
    public boolean equals(Object object) {
        ...
        AdminCreateJobOfferDTO that = (AdminCreateJobOfferDTO) object;
