...
public class AdminCreateSelectionProcessDTO {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("AdminCreateSelectionProcessDTO{");
    ...
    public boolean equals(Object object) {
        ...
        AdminCreateSelectionProcessDTO that = (AdminCreateSelectionProcessDTO) object;
