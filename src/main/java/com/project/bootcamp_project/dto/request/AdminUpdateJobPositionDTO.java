...
public class AdminUpdateJobPositionDTO {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("AdminUpdateJobPositionDTO{");
    ...
    public boolean equals(Object object) {
        ...
        AdminUpdateJobPositionDTO that = (AdminUpdateJobPositionDTO) object;
