...
public class CreateSelectionProcessDTO {
    ...
    public String toString() {
        final StringBuffer sb = new StringBuffer("CreateSelectionProcessDTO{");
    ...
    public boolean equals(Object object) {
        ...
        CreateSelectionProcessDTO that = (CreateSelectionProcessDTO) object;
